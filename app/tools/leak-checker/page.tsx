...
export default function LeakCheckerPage() {
  ...
  const performLeakTest = async () => {
    ...
    try {
      ...
      // Test DNS leak (simplified - would need backend endpoint for real DNS test)
      ...
      const isLeaked = webRTCIP !== "Not detected" || dnsData.leaked

      const testResult: LeakTestResult = {
        publicIP: ipData.ip,
        dnsIP: dnsData.dnsIP || "Protected",
        webRTCIP,
        isLeaked,
