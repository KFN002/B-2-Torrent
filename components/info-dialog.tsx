          ...
          <div className="flex items-center gap-3 mb-2">
            ...
            <div>
              ...
              <DialogDescription className="text-base">
                Privacy-First BitTorrent Client
              </DialogDescription>
            </div>
          </div>
        </DialogHeader>
        ...
        <div className="space-y-4 pt-4">
          <div className="space-y-2">
            ...
            <p className="text-sm text-muted-foreground leading-relaxed">
              B-2-Torrent is a privacy-focused BitTorrent client built with security and anonymity as core principles. 
              It features advanced multi-proxy chain support, allowing your torrenting activity to be routed through 
              multiple SOCKS5 proxies for maximum privacy protection.
            </p>
          </div>
          ...
          <div className="grid gap-3">
            ...
            <Card className="border-border/50">
              <CardContent className="flex items-start gap-3 p-4">
                ...
                <div className="space-y-1">
                  <h4 className="font-semibold text-sm">Modern Architecture</h4>
                  <p className="text-xs text-muted-foreground leading-relaxed">
                    Built with Go backend and Next.js frontend for performance and reliability
                  </p>
                </div>
              </CardContent>
            </Card>
