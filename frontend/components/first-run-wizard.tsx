    ...
    <Dialog open={open} onOpenChange={setOpen}>
      <DialogContent className="max-w-2xl glass-card">
        <DialogHeader>
          ...
          <DialogDescription>Configure the self-hosted app running on this laptop or PC</DialogDescription>
        </DialogHeader>
              ...
              <CardContent className="p-6 space-y-4">
                <div className="flex items-center gap-3 mb-4">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground">Configure local download preferences</p>
                  </div>
                </div>
                ...
                <div className="space-y-4">
                  <div className="space-y-2">
                    ...
                    <Input
                      placeholder="/Users/you/Downloads/B2Torrent or C:\Downloads\B2Torrent"
